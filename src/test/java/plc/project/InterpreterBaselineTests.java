...
public final class InterpreterBaselineTests {
    ...
    void testIntegerLiteral() {
        test(new Ast.Expression.Literal(BigInteger.ONE), BigInteger.ONE, new
                Scope(null));
    }
    @Test
    ...
    void testVariableAccess() {
        ...
        test(new Ast.Expression.Access(Optional.empty(), "num"), BigInteger.ONE,
                scope);
    }
    /**
    ...
    void testExpressionStatement() {
        ...
        test(new Ast.Statement.Expression(new Ast.Expression.Function("log",
                Arrays.asList(
                        new Ast.Expression.Literal(BigInteger.ONE)
    ...
    void testSourceInvokeMain() {
        ...
        test(new Ast.Source(Arrays.asList(), Arrays.asList()), BigInteger.ZERO,
                scope);
    }
